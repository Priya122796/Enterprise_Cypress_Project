describe(" c.Bill Search, Summary, Select Related Items", () => {
	...
	it("Verify the ability to 1.Search Bill, 2.Validate Summary 3.Navigate to Related items  ",
		{
			retries: {
				runMode: 2,
				openMode: 0,
			...
			cy.fixture('Prod.json')
				.then((data) => {
					...
					cy.Bill_Search()
					cy.Bill_SelectRelated()
					cy.Bill_SummaryValidate()
