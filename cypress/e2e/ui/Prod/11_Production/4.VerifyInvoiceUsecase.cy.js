describe(" d.Invoice Search, Summary, Select Related Items", () => {
	...
	it("Verify the ability to 1.Search Invoice, 2.Validate Summary 3.Navigate to Related items  ",
		{
			retries: {
				runMode: 2,
				openMode: 0,
